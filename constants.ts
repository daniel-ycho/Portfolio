...
export const EXPERIENCE: ExperienceItem[] = [
  ...
  },
  {
    ...
    media: [
      // PLACEHOLDERS: Replace 'url' with the actual links to your videos/social posts
      { type: 'video', title: "Cher Brand Introduction Video", url: "https://youtube.com/your-video-link" },
      { type: 'social', title: "Instagram Content Series", url: "https://instagram.com/your-post-link" }
    ]
  },
  {
    company: "Storydoor",
